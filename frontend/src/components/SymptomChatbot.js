...
const SymptomChatbot = ({ user, onVitalsUpdate }) => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 w-96 h-[600px] flex flex-col glass-card animate-slide-in">
            {/* Header */}
            ...
            {/* Input */}
            <div className="p-4 border-t border-slate-700/50 rounded-b-2xl bg-black/20">
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 px-4 py-2 bg-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all font-light"
                ...
                <p className="text-xs text-gray-500 mt-2 text-center">
                    Automated support. For emergencies, please call emergency services immediately.
                </p>
            </div>
        </div>
    );
